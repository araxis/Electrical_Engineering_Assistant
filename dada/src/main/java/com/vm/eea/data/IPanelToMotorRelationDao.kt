...
interface IPanelToMotorRelationDao {
    ...
    fun getFeederRelationByConsumerId(loadId:Long):Flow<PanelToMotorRelationEntity>

    @Query("SELECT * FROM panel_motor_relations where id= :relationId")
    fun getFeederRelationById(relationId:Long):Flow<PanelToMotorRelationEntity>
