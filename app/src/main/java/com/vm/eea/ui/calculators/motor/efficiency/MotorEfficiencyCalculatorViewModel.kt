...
import com.vm.eea.application.calculators.EfficiencyCalculator
...
class MotorEfficiencyCalculatorViewModel(private val calculator:EfficiencyCalculator):ContainerHost<UiState,Nothing>,ViewModel() {
    ...
    fun onCosPhiChange(value:String)=intent{
    ...
    private fun updateCalculationState(inputState:UiState)=intent{
        val isValid=isValid(inputState)
         if(isValid){
            ...
            val ret=calculator(power,voltage,current,system,cosPhi)
